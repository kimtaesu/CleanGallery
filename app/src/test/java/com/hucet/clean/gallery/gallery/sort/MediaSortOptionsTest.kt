...
class MediaSortOptionsTest {
    ...
    fun `DisplayName DESC Option 검증`() {
        val sortString = MediaSortOptions.getSortOptions("", mockConfig(SORT_BY_NAME or SORT_DESCENDING))
        println(sortString)
    ...
    fun `DisplayName ASC Option 검증`() {
        val sortString = MediaSortOptions.getSortOptions("", mockConfig(SORT_BY_NAME or SORT_ASCENDING))
        println(sortString)
    ...
    fun `DATE_MODIFIED DESC Option 검증`() {
        val sortString = MediaSortOptions.getSortOptions("", mockConfig(SORT_BY_DATE_MODIFIED or SORT_DESCENDING))
        println(sortString)
    ...
    fun `DATE_MODIFIED ASC Option 검증`() {
        val sortString = MediaSortOptions.getSortOptions("", mockConfig(SORT_BY_DATE_MODIFIED or SORT_ASCENDING))
        println(sortString)
